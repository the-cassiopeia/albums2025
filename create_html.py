...
HTML_END = """
  ...
  <script defer>
    ...
    document.getElementById('ratingInfoTrigger').addEventListener('click', function (e) {
      e.stopPropagation();
      const tooltip = this.querySelector('.rating-tooltip');
      const isVisible = tooltip.style.display === 'block';
      document.querySelectorAll('.rating-tooltip').forEach(t => t.style.display = 'none');
